...
Use the `coffees` property inside the App component so it contains array of objects with two
...
Create `getPrice` method in the App which accepts one parameter, coffee ID, finds the
...
Then show the result in App's template
