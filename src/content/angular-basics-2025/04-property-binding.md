...
values into CoffeeOverview component.

HTML and CSS parts of the CoffeeOverview component were updated for you. Now the HTML template contains
a text field and a button. The application should hold an amount of ordered coffees for each
CoffeeOverview component and display it in the text field. It should increase this number every time
...
Create a property called `amount` and a method called `orderCoffee` in CoffeeOverview
