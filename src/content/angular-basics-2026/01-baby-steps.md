...
display types of coffee to the user. So update generated App component so that it will show three
`span` HTML elements. Each element will represent one type of coffee. The coffee types should be
"Espresso", "Latte" and "Cappuccino".

## Step 1

Update the template property of App component to contain three span elements, each with one coffee
type.
